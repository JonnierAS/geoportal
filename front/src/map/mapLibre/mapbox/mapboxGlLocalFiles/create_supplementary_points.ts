...
function createSupplementaryPoints(geojson: any, options: any = {}, basePath = null) {
  ...
  if (type === Constants.geojsonTypes.POINT) {
    ...
    // process each line
    coordinates.forEach((line: any, lineIndex: any) => {
  ...
  function processLine(line: any, lineBasePath: any) {
    let firstPointString = '';
    let lastVertex: any = null;
    line.forEach((point: any, pointIndex: any) => {
  ...
  function isSelectedPath(path: any) {
  ...
  function processMultiGeometry() {
    ...
    coordinates.forEach((subCoordinates: any, index: any) => {
      const subFeature = {
